...
public class AbaixoDoPesoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtCategoria.setText("Categoria: Abaixo do peso!");

        imgCategoria.setImageResource(R.drawable.abaixo_peso_image); // Adicione sua imagem aqui
        txtMensagem.setText("Você está em uma condição um pouco preocupante! Mas siga firme! Procure um médico para te auxiliar.");
